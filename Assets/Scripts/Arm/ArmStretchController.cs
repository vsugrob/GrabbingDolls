...
public class ArmStretchController : MonoBehaviour {
	public Transform WristTargetAnchor;
	...
	void FixedUpdate () {
		if ( WristTargetAnchor != null )
			armIKController.WristTargetPosition = WristTargetAnchor.position;
	}
